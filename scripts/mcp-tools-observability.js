  ...
  return [
    ...
    },
    {
      ...
      description:
        ...
        'Also returns `availableProviders`: all four launchable providers in canonical order, with installed status, availability, reasons, evidence, and quota context. ' +

...
import {
  ...
  WORKER_CODEX_AGENTS_MD, WORKER_CODEX_AGENTS_MD_V1, WORKER_CODEX_AGENTS_MD_V4, WORKER_CODEX_AGENTS_MD_V6, WORKER_CODEX_AGENTS_MD_V7, WORKER_CODEX_AGENTS_MD_V8, WORKER_CODEX_AGENTS_MD_V9, WORKER_CODEX_AGENTS_MD_V10, WORKER_CODEX_AGENTS_MD_V11, WORKER_CODEX_BEHAVIORAL_MD,
  ...
  RESEARCHER_CLAUDE_SETTINGS_JSON_V1, RESEARCHER_CLAUDE_SETTINGS_JSON_V2, RESEARCHER_CLAUDE_SETTINGS_JSON_V3, RESEARCHER_AGENT_MD, RESEARCHER_AGENT_MD_V7, RESEARCHER_AGENT_MD_V8, RESEARCHER_AGENT_MD_V9,
  LIBRARY_GUIDANCE_ALL_LANES, LIBRARY_GUIDANCE_SUPERVISOR_RESEARCHER, LIBRARY_GUIDANCE_CITATION,
  ...
  LAND_WORK_PACKAGE_SKILL_MD, LAND_WORK_PACKAGE_SKILL_MD_V1, LAND_WORK_PACKAGE_SKILL_MD_V2, LAND_WORK_PACKAGE_SKILL_MD_V3, LAND_WORK_PACKAGE_SKILL_MD_V4, LAND_WORK_PACKAGE_SKILL_MD_V5, LAND_WORK_PACKAGE_SKILL_MD_V6, LAND_WORK_PACKAGE_SKILL_MD_V7, LAND_WORK_PACKAGE_SKILL_MD_V8, LAND_WORK_PACKAGE_SKILL_MD_V9,
...
/** SHA-256 hex of the v3 `remember/SKILL.md` route-first body before its
 *  expires example used a parser-valid concrete date. Used in the v4 file's
 *  previousHashes for silent v3→v4 upgrade of pristine workspaces. */
export const REMEMBER_SKILL_V3_HASH = 'ed8c8c3df21803e0df41963703609ce6cce0ee61d9466968ed47646674ccf550';
...
/** SHA-256 hex of the v4 `.lares/supervisor/.claude/skills/run-orchestration/SKILL.md`
 *  (pre-provider-preflight playbook). v5 adds workspace-default inheritance,
 *  availability-aware confirmation, and resume provider-mutation guidance. Used
 *  in the v5 file's previousHashes for silent pristine v4→v5 upgrade. */
export const SUPERVISOR_RUN_ORCHESTRATION_SKILL_V4_HASH = '68073f75aa4b4b32a55318743cc92c227d9be0060271f2565a7f46c31e1ab84c';

/** SHA-256 hex of the v5 `.lares/supervisor/.claude/skills/run-orchestration/SKILL.md`
 *  (pre-plan-ref playbook). v6 replaces the path-based new-launch vocabulary
 *  with the UUID-or-portable `plan_id` contract. Used in the v6 file's
...
/** SHA-256 hex of the v7 `.lares/supervisor/.claude/skills/run-orchestration/SKILL.md`
 *  (stale abort/restart event guidance). v8 matches the live event contract. */
export const SUPERVISOR_RUN_ORCHESTRATION_SKILL_V7_HASH = '71a0712b7814aaca9a6f8730d1b1db3a60c2b7ec9f68bc3fe3d5f8e24cf8097d';
...
/** WP-10: hashes of the five frozen orientation documents immediately before
 * their Plan-state tools paragraphs were added. */
export const SUPERVISOR_AGENT_MD_V27_HASH = '0a794ec21234a16885af8eb9d1cf5be07806c4ecb586a138440baed764e19baa';
export const SUPERVISOR_AGENT_MD_V30_HASH = 'c9ebd828c55105ffe8f0214bc9d552f508c58f0ccc9a1de4f0a4abcd7e4a77d7';
export const WORKER_CLAUDE_MD_V13_HASH = '77978b3633ef078af294e4cb040037ea37fdf8cf4787efd23332f74d97a7dfdb';
export const WORKER_CODEX_AGENTS_MD_V6_HASH = 'f2d18706ce58b4eca3e2aee479274b73231e8d84c8aefa5015d9fa84b47e392d';
/** Worker planning-surface repair: frozen managed bodies before the complete
 * plans-read tool and native-file-read guidance. */
export const WORKER_CLAUDE_MD_V14_HASH = 'a59c32f2c874e99efa7f27432cd23975db3e5a11c76bc17c8c61bd645a7850f5';
export const WORKER_CODEX_AGENTS_MD_V7_HASH = 'bd9a12303e3c076cbd686af2318f8fe7b7a4f657ba18951df51a43797686524e';
export const RESEARCHER_AGENT_MD_V7_HASH = '2dfc3dcb6db46e168e73ceb4e881a156cc49dd6d1579bfe67eb5d694708c7627';
export const RESEARCHER_CODEX_AGENTS_MD_V5_HASH = 'a8d160c3e075065ebcdf7db9075d8ae3eb2c5c9c7c0213485e11f55d3f5b848b';
...
export const LAND_WORK_PACKAGE_SKILL_MD_V9_HASH = '012a332415580b01f39b296492811cd2a6e756025e3967febcf418a28048c9f5';
...
// WP-12 (plan_37cf5261) — frozen hash of the committed v5 helper before the
...
export const RESEARCHER_CODEX_AGENTS_MD_V7_HASH = '2263998f8c3d4a7223ac5e8d49cca1ab57c0befd1850c91aab8a0a03228c2e97';
...
export const RESEARCHER_CODEX_AGENTS_MD_V7 = RESEARCHER_CODEX_AGENTS_MD_V6
  .split(LEGACY_LIBRARY_PREFIX).join('.lares/library/');
export const RESEARCHER_CODEX_AGENTS_MD = `${RESEARCHER_CODEX_AGENTS_MD_V7.trimEnd()}
...
export class AgentSupervisor extends EventEmitter {
  ...
  static readonly LEGACY_SUPERVISOR_FILES: Record<string, ScaffoldFile> = {
    ...
    [`.lares/supervisor/.claude/skills/run-orchestration/SKILL.md`]:              {
      ...
      version: 8, // v8 corrects the abort/restart event guidance
      previousHashes: { 1: SUPERVISOR_RUN_ORCHESTRATION_SKILL_V1_HASH, 2: SUPERVISOR_RUN_ORCHESTRATION_SKILL_V2_HASH, 3: SUPERVISOR_RUN_ORCHESTRATION_SKILL_V3_HASH, 4: SUPERVISOR_RUN_ORCHESTRATION_SKILL_V4_HASH, 5: SUPERVISOR_RUN_ORCHESTRATION_SKILL_V5_HASH, 6: SUPERVISOR_RUN_ORCHESTRATION_SKILL_V6_HASH, 7: SUPERVISOR_RUN_ORCHESTRATION_SKILL_V7_HASH },
    },
    ...
    [`.lares/supervisor/.claude/skills/remember/SKILL.md`]:                       { content: REMEMBER_SKILL, version: 4, previousHashes: { 1: REMEMBER_SKILL_V1_HASH, 2: REMEMBER_SKILL_V2_HASH, 3: REMEMBER_SKILL_V3_HASH } }, // v4: parser-valid concrete date in the expires example
  ...
  private static WORKER_FILES_CLAUDE: Record<string, ScaffoldFile> = {
    ...
    [`.lares/workers/claude/.claude/skills/land-work-package/SKILL.md`]: {
      ...
      version: 10, // v10 single-invocation temp-index transaction + real-index resync (stale-index incident 2026-09-07)
      previousHashes: {
        ...
        9: LAND_WORK_PACKAGE_SKILL_MD_V9_HASH,
      },
    },
    [`.lares/workers/claude/CLAUDE.md`]:                       {
      content: WORKER_CLAUDE_MD,
      version: 19, // v19 adds Workspace Library tool-use and citation guidance.
      previousHashes: { 1: sha256Hex(WORKER_CLAUDE_MD_V1), 2: WORKER_CLAUDE_MD_V2_HASH, 3: WORKER_CLAUDE_MD_V3_HASH, 4: WORKER_CLAUDE_MD_V4_HASH, 5: WORKER_CLAUDE_MD_V5_HASH, 6: WORKER_CLAUDE_MD_V6_HASH, 7: WORKER_CLAUDE_MD_V7_HASH, 8: WORKER_CLAUDE_MD_V8_HASH, 9: WORKER_CLAUDE_MD_V9_HASH, 10: WORKER_CLAUDE_MD_V10_HASH, 11: WORKER_CLAUDE_MD_V11_HASH, 12: WORKER_CLAUDE_MD_V12_HASH, 13: WORKER_CLAUDE_MD_V13_HASH, 14: WORKER_CLAUDE_MD_V14_HASH,
        15: sha256Hex(WORKER_CLAUDE_MD_V15), 16: sha256Hex(WORKER_CLAUDE_MD_V16), 17: WORKER_CLAUDE_MD_V17_HASH, 18: WORKER_CLAUDE_MD_V18_HASH },
    },
    ...
    // skill root.
    [`.lares/workers/claude/.claude/skills/remember/SKILL.md`]:       { content: REMEMBER_SKILL, version: 4, previousHashes: { 1: REMEMBER_SKILL_V1_HASH, 2: REMEMBER_SKILL_V2_HASH, 3: REMEMBER_SKILL_V3_HASH } }, // v4: parser-valid concrete date in the expires example
  ...
  private static RESEARCHER_FILES: Record<string, ScaffoldFile> = {
    ...
    [`.lares/researcher/claude/CLAUDE.md`]: { content: RESEARCHER_AGENT_MD, version: 10, previousHashes: { 1: RESEARCHER_AGENT_MD_V1_HASH, 2: RESEARCHER_AGENT_MD_V2_HASH, 3: RESEARCHER_AGENT_MD_V3_HASH, 4: RESEARCHER_AGENT_MD_V4_HASH, 5: RESEARCHER_AGENT_MD_V5_HASH, 6: RESEARCHER_AGENT_MD_V6_HASH, 7: RESEARCHER_AGENT_MD_V7_HASH, 8: RESEARCHER_AGENT_MD_V8_HASH, 9: RESEARCHER_AGENT_MD_V9_HASH } },
  ...
  static RESEARCHER_FILES_CODEX: Record<string, ScaffoldFile> = {
    [`.lares/researcher/codex/AGENTS.md`]: { content: RESEARCHER_CODEX_AGENTS_MD, version: 8, previousHashes: { 1: sha256Hex(RESEARCHER_CODEX_AGENTS_MD_V1), 2: sha256Hex(RESEARCHER_CODEX_AGENTS_MD_V2), 3: RESEARCHER_CODEX_AGENTS_MD_V3_HASH, 4: sha256Hex(RESEARCHER_CODEX_AGENTS_MD_V4), 5: RESEARCHER_CODEX_AGENTS_MD_V5_HASH, 6: RESEARCHER_CODEX_AGENTS_MD_V6_HASH, 7: RESEARCHER_CODEX_AGENTS_MD_V7_HASH } },
    ...
    if (provider === 'claude') {
      ...
      const codexFiles: Record<string, ScaffoldFile> = {
        ...
        [`.lares/workers/codex/AGENTS.md`]: {
          ...
          version: 12, // v12 adds Workspace Library tool-use and citation guidance.
          previousHashes: { 1: WORKER_CODEX_AGENTS_MD_V1_HASH, 2: WORKER_CODEX_AGENTS_MD_V2_HASH, 3: WORKER_CODEX_AGENTS_MD_V3_HASH, 4: WORKER_CODEX_AGENTS_MD_V4_HASH, 5: WORKER_CODEX_AGENTS_MD_V5_HASH, 6: WORKER_CODEX_AGENTS_MD_V6_HASH, 7: WORKER_CODEX_AGENTS_MD_V7_HASH,
            8: sha256Hex(WORKER_CODEX_AGENTS_MD_V8), 9: sha256Hex(WORKER_CODEX_AGENTS_MD_V9), 10: WORKER_CODEX_AGENTS_MD_V10_HASH, 11: WORKER_CODEX_AGENTS_MD_V11_HASH },
        },
        ...
        [`.lares/workers/codex/.agents/skills/remember/SKILL.md`]: {
          ...
          version: 4, // v4: parser-valid concrete date in the expires example
          previousHashes: { 1: REMEMBER_SKILL_V1_HASH, 2: REMEMBER_SKILL_V2_HASH, 3: REMEMBER_SKILL_V3_HASH },
        },
      };

...
import {
  ...
  SUPERVISOR_AGENT_NAME, SUPERVISOR_AGENT_MD, SUPERVISOR_AGENT_MD_V24, SUPERVISOR_AGENT_MD_V27, SUPERVISOR_MEMORY_MD,
  ...
  WORKER_CLAUDE_MD, WORKER_CLAUDE_MD_V1, WORKER_CLAUDE_MD_V11, WORKER_CLAUDE_MD_V13, WORKER_CLAUDE_MD_V14, WORKER_BEHAVIORAL_MD,
  ...
  WORKER_CODEX_AGENTS_MD, WORKER_CODEX_AGENTS_MD_V1, WORKER_CODEX_AGENTS_MD_V4, WORKER_CODEX_AGENTS_MD_V6, WORKER_CODEX_AGENTS_MD_V7, WORKER_CODEX_BEHAVIORAL_MD,
...
export class AgentSupervisor extends EventEmitter {
  ...
  private static SUPERVISOR_FILES: Record<string, ScaffoldFile> = {
    ...
    [`.lares/supervisor/CLAUDE.md`]:                                              {
      ...
      version: 28, // v28 replaces retired plan readers and adds the bounded plan-state orientation.
  ...
  private static WORKER_FILES_CLAUDE: Record<string, ScaffoldFile> = {
    ...
    [`.lares/workers/claude/CLAUDE.md`]:                       {
      ...
      version: 15, // v15 replaces retired section-reader guidance with the complete plans-read/native-file contract.
    ...
    if (provider === 'claude') {
      ...
      const codexFiles: Record<string, ScaffoldFile> = {
        ...
        [`.lares/workers/codex/AGENTS.md`]: {
          ...
          version: 8, // v8 inherits the complete worker plans-read/native-file contract.
